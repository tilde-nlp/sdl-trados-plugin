...
CreateDirectory "$SMPROGRAMS\Tilde Machine Translation Provider 2009"
CreateShortCut "$SMPROGRAMS\Tilde Machine Translation Provider 2009\Uninstall.lnk" "$INSTDIR\uninstaller.exe"
...
Delete "$SMPROGRAMS\Tilde Machine Translation Provider 2009\Uninstall.lnk"
RMDIR "$SMPROGRAMS\Tilde Machine Translation Provider 2009"
