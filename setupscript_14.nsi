...
outFile "LetsMTProvider_2014.exe"
...
StrCpy $INSTDIR "$LOCALAPPDATA\SDL\SDL Trados Studio\11\Plugins\Packages"
${Else}
# set appdata folder as install directory 
StrCpy $INSTDIR "$APPDATA\..\Local Settings\Application Data\SDL\SDL Trados Studio\11\Plugins\Packages"
${EndIf}
FunctionEnd 
...
file "C:\Users\rihards.krislauks\Documents\Visual Studio 2013\Projects\LetsMT\SDLTradosPlugin_v2014_linked\LetsMT.MTProvider.sdlplugin"
 
# define uninstaller name
writeUninstaller $INSTDIR\uninstaller.exe

CreateDirectory "$SMPROGRAMS\Tilde Machine Translation Provider 2014"
CreateShortCut "$SMPROGRAMS\Tilde Machine Translation Provider 2014\Uninstall.lnk" "$INSTDIR\uninstaller.exe"
...
Delete "$SMPROGRAMS\Tilde Machine Translation Provider 2014\Uninstall.lnk"
RMDIR "$SMPROGRAMS\Tilde Machine Translation Provider 2014"
